...
/**
 * Servlet implementation class ServletGetAllCategories
 */
@WebServlet("/ServletGetAllCategories")
public class ServletGetAllCategories extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletGetAllCategories() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Gson gson = new Gson();
		out.print(gson.toJson(listaCategorie));
	}
